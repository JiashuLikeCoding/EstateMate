-- Update the shared/default OpenHouse template content (per-user rows)
-- This targets existing templates named "Open House" (and legacy "Open House模版") in workspace=openhouse.
